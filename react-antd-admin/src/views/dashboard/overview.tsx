  ...
  return (
    <Row gutter={[10, 10]} style={{ marginBottom: 10 }}>
      ...
      <ColCard
        ...
        footer={<Field name={formatMessage({ id: 'app.dashboard.overview.visits.dailyVisits' })} number="1234" />}
      />
      <ColCard
        loading={loading}
        ...
        footer={<Field name={formatMessage({ id: 'app.dashboard.overview.conversionRate' })} number="45" />}
      />
      <ColCard
        loading={loading}
        ...
        footer={<Field name={formatMessage({ id: 'app.dashboard.salePercent.proportionOfSales' })} number="90%" />}
      />
    </Row>
  );
};
